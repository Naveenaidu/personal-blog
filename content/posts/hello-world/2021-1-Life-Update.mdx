...
That said, the every exciting part is, I got selected into the Linux Kernel 
mentorship Program for the PCI Project. I've always wanted to get into system
programming; away from most of the abstractions. And I finally do have the chance
to work on the Linux Kernel. I couldn't believe when I received the acceptance mail.
The only thing I was worried about was handling two full time work simultaneously.
But after spending almost 1 and half month managing both, things seem fine :)
